...
function CheckVehicleIsAtSide()
{
	...
	This function should do the following: 
	 ...
	 - cars are considered parallel if the absolute difference between their kms_driven properties is less than 25 px and they have non-matching x_coordinate properties	*/
}
...
function IdentifyAssailant()
{
	/*
	This function should do the following: 
	 - Check cars passing parallel to detective_vehicleObject to see if they match the licence_plate property in the assailant description.
